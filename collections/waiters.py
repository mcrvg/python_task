...
starters=["garlic bread","olives","prawns"]
print("as started we have",starters)

# Take an input for the user for their starter
starter=input("What would you like as starter?")

# Print a list of mains
mains=["chicken","beef","fish"]
print("as main we have",mains)
# Take an input for the user for their main course
main=input("What would you like as main?")

# Print a list of desserts
desserts=["cheese cake","fruit","ice cream"]
print("for dessert we have",desserts)
# Take an input for the user for their dessert
dessert=input("any dessert?")
# Print all of the user's choices
print("The guess order as starter", starter,"as main", main, "and for dessert", dessert)
